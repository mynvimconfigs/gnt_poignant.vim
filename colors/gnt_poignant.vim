...
if exists("syntax_on")
  ...
  let g:colors_name = "gnt_poignant"

  hi Cursor  guifg=NONE guibg=#aeb8b8 gui=NONE
  ...
  hi LineNr  guifg=#B1C6D8 guibg=#fffef9 gui=NONE
  ...
  hi Comment  guifg=#ababab guibg=NONE gui=NONE
  ...
  "hi phpIdentifier  guifg=#000000 guibg=NONE gui=bold
  hi phpSpecial  guifg=#cd7700 guibg=NONE gui=bold
  hi phpSpecialFunction  guifg=#cd7700 guibg=NONE gui=bold
  hi phpVarSelector  guifg=#2d669a guibg=NONE gui=bold
